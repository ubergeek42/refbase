...
//		displayHTMLhead(encodeHTML($officialDatabaseName) . " -- Add Literature from CSA Record Data", "index,follow", "Extract literature data from Cambridge Scientific Abstracts and add the data to the " . encodeHTML($officialDatabaseName), "", false, "", $viewType, array());
