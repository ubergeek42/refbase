...
CREATE TABLE `group_permissions` (
  `group_permission_id` mediumint(8) unsigned NOT NULL auto_increment,
...
INSERT INTO `group_permissions` VALUES (1, 1, 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no');
...
INSERT INTO `groups` VALUES (1, 'refbase users', '1');
...
CREATE TABLE `help` (
  ...
  `text` text,
  `language` varchar(100) default NULL,
  `help_order` varchar(25) default NULL,
  `related` text,
  `keywords` text,
  `notes` text,
  `approved` enum('no','yes') NOT NULL default 'no',
  ...
  `modified_by` varchar(100) default NULL,
  PRIMARY KEY  (`help_id`),
  KEY `topic_id` (`topic_id`,`category_id`)
...
INSERT INTO `help` VALUES (1, 1, 1, 'Hello Spencer', 'Dies ist der beschreibende Text zu Hallo Spencer!', 'German', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 2, 2, 'refbase FAQ', 'Dies ist die erste Form eines refbase FAQ Systems', 'German', NULL, NULL, 'refbase', NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 2, 2, 'refbase FAQ', 'This is the first form of a refbase FAQ system', 'English', NULL, NULL, 'refbase', NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 3, 10, 'Can I import RIS-formatted data?', 'Yes, you can! Click the \'Import\' link within the header, choose \'RIS\' format, and paste your RIS-formatted data into the text entry field. Then click the \'Import\' button. Currently, import is limited to one record at a time. For batch import please consult your database admin.', 'English', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 4, 11, 'How can I import RIS data from EndNote?', 'In EndNote, choose \'Export\' from the \'File\' menue, in the upcoming dialog choose \'RIS\' from the format popup. Save the exported data as text file, open this text file in a text editor and copy the file contents into the text entry field of the Import page.', 'English', 'b', NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 4, 11, 'Wie kann ich RIS-Daten aus EndNote importieren?', 'Waehlen Sie in EndNote \'Export\' aus dem \'Ablage\'-Menue...', 'German', 'a', NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 5, 13, 'Author', 'This field contains the authors of this publication.', 'English', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 6, 7, 'Can I import BibTeX data?', 'Yes, you can! Click the \'Import\' link within the header, choose \'BibTeX\' format, and paste your BibTeX-formatted data into the text entry field. Then click the \'Import\' button. Currently, import is limited to one record at a time. For batch import please consult your database admin.', 'English', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(9, 7, 4, 'Hilfe, meine Kekse sind weg?', 'Was, wenn alle mir meine Kekse wegfressen?.', 'German', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 4, 11, 'Hvordan er det mulig a importerer RIS dataer fra EndNote?', '(hier steht der norwegische Text...)', 'Norwegian', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 8, 14, 'Can I import ProCite data?', 'Yes, you can! Click the \'Import\'...', 'English', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 9, 13, 'Title', 'This fields holds the title of your publication', 'English', NULL, NULL, NULL, NULL, 'no', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL);
...
DROP TABLE IF EXISTS `help_cats`;
CREATE TABLE `help_cats` (
  `cat_id` mediumint(8) unsigned NOT NULL auto_increment,
  `parent_id` mediumint(8) unsigned NOT NULL default '0',
  `category` varchar(150) default NULL,
  `cat_desc` varchar(255) default NULL,
  `cat_order` varchar(25) default NULL,
  PRIMARY KEY  (`cat_id`),
  KEY `parent_id` (`parent_id`)
) TYPE=MyISAM AUTO_INCREMENT=16 ;

#
# data for table `help_cats`
#

INSERT INTO `help_cats` VALUES (1, 0, 'Spencer', NULL, NULL),
(2, 0, 'Erni', NULL, NULL),
(3, 0, 'Bert', NULL, NULL),
(4, 1, 'Kekse', NULL, NULL),
(5, 0, 'Import', NULL, NULL),
(6, 0, 'Export', NULL, NULL),
(7, 5, 'BibTeX Import', NULL, NULL),
(8, 6, 'BibTeX Export', NULL, NULL),
(9, 6, 'RIS Export', NULL, NULL),
(10, 5, 'RIS Import', NULL, NULL),
(11, 10, 'RIS Import from EndNote', NULL, NULL),
(12, 0, 'Adding/Editing of Records', NULL, NULL),
...
INSERT INTO `refs` VALUES ('Chapelle, G; Peck, LS', NULL, NULL, 'Chapelle, G', 2, 'Polar gigantism dictated by oxygen availability', NULL, 'Nature', 'Nature', 1999, '399', 399, NULL, '114-115', 114, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0028-0836', NULL, 'English', NULL, 'Black Sea; Caspian Sea; Lake Baikal', 'Journal Article', NULL, NULL, NULL, NULL, NULL, 'refbase @ user @ 137', 'Initial refbase user (user@refbase.net)', NULL, 'no', NULL, NULL, NULL, 1, NULL, 'no', '2001-04-30', '18:56:26', 'Initial refbase user (user@refbase.net)', '2004-01-08', '21:20:55', 'Initial refbase user (user@refbase.net)'),
...
INSERT INTO `user_styles` VALUES (1, 1, 1, 'true'),
(2, 2, 1, 'true'),
(3, 3, 1, 'true'),
(4, 4, 1, 'true'),
(5, 5, 1, 'true'),
